...
import { selectAuthState, update } from "../features/auth/authSlide";

export default function About() {
    // get auth state
    const { profile, email } = useAppSelector(selectAuthState);
    // use for get function on state
                    ...
                    >
                        <Box mb={{ base: 8, md: 20 }}>
                            ...
                            <Text fontSize={"xl"} color={"gray.400"}>
                                The NewLife™ technology allows you to monitor
                                your crops and get complete insights at real
                                time. The proprietary software/hardware
                                ecosystem prevents your plants from getting
                                neglected.
                            </Text>
                        </Box>
